...
function buildHistogram(year) {
    ...
    // get the data
    d3.json("/salaries/" + year).then(function(data) {
        console.log(data);
        ...
        svg.append("text").attr("x", (width / 2)).attr("y", (margin.top / 10)).attr("text-anchor", "middle").classed("title", true).text("Density of Base Pay and Overtime Pay")
            // append y axis
        svg.append("text")
